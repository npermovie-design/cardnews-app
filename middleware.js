...
const PAGE_META = {
  ...
  "/pricing": {
    ...
    desc: "비회원 5회 무료 체험! 합리적인 가격으로 AI 블로그, 이미지, 쇼츠 영상 이용 횟수를 충전하세요.",
  ...
  "/event": {
    title: "SNS메이킷 이벤트 - 인플루언서 모집 & 이용권 지급",
    desc: "인플루언서 모집 중! 후기 작성 시 AI 이용권을 지급합니다. 지금 참여하세요!",
    keywords: "SNS메이킷 이벤트, 인플루언서 모집, 이용권 이벤트",
  },
  "/cases": {
  ...
  "/mypage": {
    title: "SNS메이킷 마이페이지",
    desc: "내 계정, 이용 횟수, 생성 히스토리를 관리하세요.",
    keywords: "마이페이지, 계정관리",
  },
  "/snsnews": {
  ...
  "/challenge": {
    title: "SNS메이킷 부트캠프 - 함께 도전하고 결과를 만드세요",
    desc: "SNS 수익화, 포스팅 습관 만들기, 브랜딩 부트캠프에 참여하세요. 함께 하면 습관이 됩니다.",
    keywords: "SNS 부트캠프, 블로그 부트캠프, 인스타 부트캠프, SNS 수익화, 포스팅 부트캠프",
  },
};
