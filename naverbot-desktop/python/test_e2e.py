...
# ── 테스트 정보 ──
LICENSE_KEY = os.environ.get("NAVERBOT_TEST_LICENSE_KEY", "")
...
def main():
    if not LICENSE_KEY or not NAVER_ID or not NAVER_PW:
        print("NAVERBOT_TEST_LICENSE_KEY, NAVERBOT_TEST_NAVER_ID, Windows Credential Manager 비밀번호가 필요합니다.")
        return
