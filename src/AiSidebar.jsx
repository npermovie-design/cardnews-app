...
function AiSidebar({ aiMenu, setAiMenu, user, onQna, theme, onlineCount, navigate, onLogout }) {
  ...
  const menuItems = [
    ...
    { sep:true },
    { id:"blog_write", label:"글쓰기", icon:"/icons3d/blog-write.png", ids:["blog_naver","blog_tistory","blog_insta","blog_youtube","blog_thread","blog_cafe","blog_yt_blog","blog_news","blog_link","auto_publish"] },
    ...
    { id:"video_edit", label:"영상", icon:"/icons3d/sns-app.png", ids:["shorts_make"], badge:"NEW" },
    { sep:true },
