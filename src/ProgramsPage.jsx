...
const AUTOMATION_DOWNLOAD = {
  fileName: "SNSMakeIt-Setup-0.2.1.exe",
  url: "https://ckzjnpzadeovrasucjmu.supabase.co/storage/v1/object/public/naverbot-releases/SNSMakeIt-Setup-0.2.1.exe",
  size: "430MB",
  version: "v0.2.1",
};
...
const DEMO_PRODUCTS = [
  {
    ...
    version: "v0.2.1", platform: "Windows 10/11",
    fileSize: "430MB", downloadCount: 180, viewCount: 420,
    tags: ["자동화", "블로그", "네이버", "SEO", "AEO", "영상편집"],
    downloadUrl: "https://ckzjnpzadeovrasucjmu.supabase.co/storage/v1/object/public/naverbot-releases/SNSMakeIt-Setup-0.2.1.exe",
    ...
    detailContent: [
      ...
      { type: "divider" },
      { type: "heading", value: "v0.2.1 주요 기능" },
