...
const AUTOMATION_DOWNLOAD = {
  fileName: "SNSMakeIt-Setup-0.2.7.zip",
  url: "https://github.com/npermovie-design/cardnews-app/releases/download/app-v0.2.7/SNSMakeIt-Setup-0.2.7.zip",
  size: "452MB",
  version: "v0.2.7",
};
...
const DEMO_PRODUCTS = [
  {
    ...
    version: "v0.2.7", platform: "Windows 10/11",
    fileSize: "430MB", downloadCount: 180, viewCount: 420,
    tags: ["자동화", "블로그", "네이버", "글쓰기", "SEO", "영상편집"],
    downloadUrl: "https://github.com/npermovie-design/cardnews-app/releases/download/app-v0.2.7/SNSMakeIt-Setup-0.2.7.zip",
