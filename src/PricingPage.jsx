...
const SUB_PLANS = [
  ...
  },
  {
    ...
    highlight: false, badge: null,
    features: ["매월 1,200P 지급", "AI 글쓰기 약 40회", "이미지 생성 약 4회", "쇼츠 영상 약 12회", ...COMMON_FEATURES],
    btnLabel: "시작하기",
  ...
  },
  {
    ...
    features: ["매월 2,800P 지급", "AI 글쓰기 약 93회", "이미지 생성 약 11회", "쇼츠 영상 약 28회", ...COMMON_FEATURES],
    btnLabel: "시작하기",
  ...
  },
  {
    ...
    features: ["매월 5,500P 지급", "AI 글쓰기 약 183회", "이미지 생성 약 22회", "쇼츠 영상 약 55회", ...COMMON_FEATURES],
    btnLabel: "시작하기",
