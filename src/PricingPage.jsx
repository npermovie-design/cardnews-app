...
const PLANS = [
  {
    ...
    limits: { write: 5, video: 1, naver: 0 },
    features: ["가입 시 5회 글쓰기 제공", "영상 편집 1회", "커뮤니티 이용", "키워드 분석"],
    btnLabel: "무료로 시작",
    free: true,
  },
  {
    ...
    highlight: false, badge: null,
    limits: { write: 50, video: 5, naver: 0 },
    features: ["AI 글쓰기 월 50회", "영상 편집 월 5회", "20개+ SNS 플랫폼 지원", "커뮤니티 이용", "키워드 분석", "이메일 지원"],
    btnLabel: "시작하기",
  ...
  },
  {
    ...
    limits: { write: 200, video: 20, naver: 3 },
    features: ["AI 글쓰기 월 200회", "영상 편집 월 20회", "NaverBot 자동발행 일 3회", "20개+ SNS 플랫폼 지원", "커뮤니티 이용", "키워드 분석", "이메일 지원"],
    btnLabel: "시작하기",
  ...
  },
  {
    ...
    limits: { write: 500, video: 50, naver: 10 },
    features: ["AI 글쓰기 월 500회", "영상 편집 월 50회", "NaverBot 자동발행 일 10회", "카페 발행 가능", "20개+ SNS 플랫폼 지원", "커뮤니티 이용", "키워드 분석", "우선 고객 지원"],
    btnLabel: "시작하기",
    lsId: "",
    lsIdYearly: "",
  },
...
const LIMIT_LABELS = [
  ...
  { key: "video", label: "영상 편집" },
];

const COMPARE_ROWS = [
  { label: "AI 글쓰기", vals: ["5회/월", "50회/월", "200회/월", "500회/월"], types: ["num","num","num","highlight"] },
  { label: "영상 편집", vals: ["1회/월", "5회/월", "20회/월", "50회/월"], types: ["num","num","num","num"] },
...
const FAQ_LIST = [
  ...
  { q: "무료 플랜으로도 충분한가요?", a: "월 5회 AI 글쓰기와 영상 편집 1회를 무료로 체험할 수 있습니다. 본격적으로 콘텐츠를 제작하신다면 Basic 이상을 추천합니다." },
