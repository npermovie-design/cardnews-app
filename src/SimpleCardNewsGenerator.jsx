...
const DESIGN_PRESETS = [
  ...
  // ── 비즈니스/전문가 ──────────────────────────────────────
  { key:"corp_blue",    label:"코퍼레이트 블루", bgColor:"#0b1d51", textColor:"#ffffff", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"middle", hlMode:"pill",      lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"gold_premium", label:"골드 프리미엄",   bgColor:"#0a0a0a", textColor:"#d4af37", titleSize:36, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"center", textValign:"middle", hlMode:"box",       lineHeightTitle:1.25, lineHeightBody:1.7 },
  { key:"grayscale",    label:"그레이 스케일",   bgColor:"#2c2c2c", textColor:"#e0e0e0", titleSize:32, bodySize:14, subtitleSize:11, highlightSize:14, titleWeight:"700", textAlign:"left",   textValign:"middle", hlMode:"underline", lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"biz_red",      label:"비즈니스 레드",   bgColor:"#1a0000", textColor:"#ff3b3b", titleSize:36, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"bottom", hlMode:"box",       lineHeightTitle:1.2,  lineHeightBody:1.6 },
  { key:"clean_white",  label:"클린 화이트",     bgColor:"#ffffff", textColor:"#333333", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"700", textAlign:"left",   textValign:"middle", hlMode:"underline", lineHeightTitle:1.4,  lineHeightBody:1.8 },

  // ── 트렌디/감성 ──────────────────────────────────────────
  { key:"insta_mood",   label:"인스타 감성",     bgColor:"#f5ebe0", textColor:"#5c4033", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"newtro",       label:"뉴트로",         bgColor:"#3d2b1f", textColor:"#f4d9a0", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"bottom", hlMode:"box",       lineHeightTitle:1.25, lineHeightBody:1.7 },
  { key:"y2k",          label:"Y2K",            bgColor:"#e0aaff", textColor:"#240046", titleSize:36, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"pop_art",      label:"팝아트",         bgColor:"#ffe600", textColor:"#ff0055", titleSize:38, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"center", textValign:"middle", hlMode:"box",       lineHeightTitle:1.2,  lineHeightBody:1.6 },
  { key:"mood_lamp",    label:"무드등",         bgColor:"#1a1423", textColor:"#ffb347", titleSize:32, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.35, lineHeightBody:1.8 },
  { key:"cafe_mood",    label:"카페무드",       bgColor:"#3e2723", textColor:"#efebe9", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"700", textAlign:"left",   textValign:"middle", hlMode:"underline", lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"spring_pastel",label:"봄 파스텔",      bgColor:"#fce4ec", textColor:"#2e7d32", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"summer_cool",  label:"여름 시원",      bgColor:"#e0f7fa", textColor:"#01579b", titleSize:32, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.35, lineHeightBody:1.7 },
  { key:"autumn_leaf",  label:"가을 단풍",      bgColor:"#4e342e", textColor:"#ffcc80", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"bottom", hlMode:"box",       lineHeightTitle:1.25, lineHeightBody:1.7 },
  { key:"winter_snow",  label:"겨울 눈꽃",      bgColor:"#eceff1", textColor:"#263238", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"700", textAlign:"center", textValign:"middle", hlMode:"underline", lineHeightTitle:1.4,  lineHeightBody:1.8 },

  // ── 고급/럭셔리 ──────────────────────────────────────────
  { key:"marble",       label:"마블",           bgColor:"#e8e8e8", textColor:"#2d2d2d", titleSize:32, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"underline", lineHeightTitle:1.35, lineHeightBody:1.7 },
  { key:"rose_gold",    label:"로즈골드",       bgColor:"#2b1b17", textColor:"#f4c2c2", titleSize:34, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.3,  lineHeightBody:1.8 },
  { key:"dark_navy",    label:"다크 네이비",    bgColor:"#0d1b2a", textColor:"#e0e1dd", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"middle", hlMode:"box",       lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"emerald",      label:"에메랄드",       bgColor:"#004d40", textColor:"#a7ffeb", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"burgundy",     label:"버건디",         bgColor:"#3c0014", textColor:"#f8bbd0", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"bottom", hlMode:"box",       lineHeightTitle:1.25, lineHeightBody:1.7 },

  // ── 귀여운/캐주얼 ────────────────────────────────────────
  { key:"candy_pop",    label:"캔디팝",         bgColor:"#ff80ab", textColor:"#fff9c4", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"mint_choco",   label:"민트초코",       bgColor:"#e0f2f1", textColor:"#4e342e", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"lavender_dream",label:"라벤더 드림",   bgColor:"#e8daf5", textColor:"#4a148c", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"peach",        label:"피치",           bgColor:"#ffecd2", textColor:"#bf360c", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"sky",          label:"스카이",         bgColor:"#e3f2fd", textColor:"#0d47a1", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"700", textAlign:"center", textValign:"middle", hlMode:"underline", lineHeightTitle:1.4,  lineHeightBody:1.8 },

  // ── 실사/사진풍 ──────────────────────────────────────────
  { key:"magazine_layout",label:"잡지 레이아웃", bgColor:"#fafaf0", textColor:"#1a1a1a", titleSize:38, bodySize:14, subtitleSize:11, highlightSize:14, titleWeight:"900", textAlign:"left",   textValign:"bottom", hlMode:"none",      lineHeightTitle:1.2,  lineHeightBody:1.6 },
  { key:"magazine_black",label:"매거진 블랙",    bgColor:"#000000", textColor:"#ffffff", titleSize:40, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"center", textValign:"middle", hlMode:"none",      lineHeightTitle:1.15, lineHeightBody:1.6 },
  { key:"photo_card",   label:"포토카드",       bgColor:"#f5f5f5", textColor:"#212121", titleSize:28, bodySize:13, subtitleSize:11, highlightSize:13, titleWeight:"700", textAlign:"center", textValign:"bottom", hlMode:"underline", lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"documentary",  label:"다큐멘터리",     bgColor:"#1b1b1b", textColor:"#ffd600", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"bottom", hlMode:"box",       lineHeightTitle:1.2,  lineHeightBody:1.6 },
  { key:"news_brief",   label:"뉴스 브리핑",    bgColor:"#0d47a1", textColor:"#ffffff", titleSize:36, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"left",   textValign:"middle", hlMode:"pill",      lineHeightTitle:1.25, lineHeightBody:1.7 },

  // ── 보너스 추가 스타일 ───────────────────────────────────
  { key:"electric_violet",label:"일렉트릭 바이올렛", bgColor:"#12002e", textColor:"#bf7fff", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"center", textValign:"middle", hlMode:"box",    lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"sand_desert",  label:"사막 모래",       bgColor:"#c2b280", textColor:"#3e2723", titleSize:32, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"left",   textValign:"middle", hlMode:"underline", lineHeightTitle:1.35, lineHeightBody:1.8 },
  { key:"cherry_blossom",label:"벚꽃",          bgColor:"#fff0f5", textColor:"#880e4f", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.4,  lineHeightBody:1.8 },
  { key:"deep_sea",     label:"심해",           bgColor:"#001f3f", textColor:"#7fdbff", titleSize:34, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.3,  lineHeightBody:1.7 },
  { key:"neon_green",   label:"네온 그린",      bgColor:"#0a0a0a", textColor:"#39ff14", titleSize:36, bodySize:15, subtitleSize:12, highlightSize:15, titleWeight:"900", textAlign:"center", textValign:"middle", hlMode:"box",       lineHeightTitle:1.2,  lineHeightBody:1.6 },
  { key:"cotton_candy", label:"솜사탕",         bgColor:"#fce4f1", textColor:"#6a1b9a", titleSize:30, bodySize:14, subtitleSize:12, highlightSize:14, titleWeight:"800", textAlign:"center", textValign:"middle", hlMode:"pill",      lineHeightTitle:1.4,  lineHeightBody:1.8 },
];
