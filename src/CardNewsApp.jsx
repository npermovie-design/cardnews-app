...
export function PlannerPanel(props) {
  ...
  var tabActive = isDark ? "rgba(99,102,241,0.5)"     : "#7c6aff";
...
function PageMake(props) {
  ...
  var tagClr  = D ? "rgba(255,255,255,0.6)"    : "#7c6aff";
  var tagAbg  = D ? "rgba(99,102,241,0.4)"     : "#7c6aff";
  var tagAClr = "#fff";
  var stepDone= D ? "#7c6aff"                  : "#7c6aff";
  var stepAct = D ? "rgba(99,102,241,0.5)"     : "rgba(99,102,241,0.15)";
  var stepInact= D ? "rgba(255,255,255,0.1)"   : "#e5e3f5";
  var stepActTxt= D ? "#fff"                   : "#7c6aff";
