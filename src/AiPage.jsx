...
function AiContent({ aiMenu, user, setAiMenu, navigate, navigateBoard, navigateAi, C, theme, onLoginRequest, onUserUpdate }) {
  ...
  if (aiMenu === "video_create" || aiMenu === "shorts_make" || aiMenu === "virality") {
    ...
    return (
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
        <iframe src={(() => { const base = import.meta.env.VITE_SHORTS_FACTORY_URL || (window.location.hostname === "localhost" ? "http://localhost:8000" : "https://shorts-factory-r33o.onrender.com"); return aiMenu === "virality" ? base + "/virality" : base; })()} style={{ flex:1, border:"none", width:"100%", height:"100%" }} allow="autoplay; fullscreen" />
      </div>
    );
  }
