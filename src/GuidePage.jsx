    ...
    guides: [
      {
        id: "bootcamp",
        title: "크루잉 참여",
        desc: "SNS 운영 크루잉에 참여해서 다른 사업자들과 함께 성장합니다",
        category: "커뮤니티",
        steps: [
          { title: "크루잉 페이지 접속", body: "상단 메뉴에서 '크루잉'를 클릭하면 현재 진행 중인 크루잉 목록을 확인할 수 있습니다.\n\n크루잉 종류:\n- 블로그 30일 크루잉: 매일 1개 블로그 글 작성\n- SNS 운영 실전: 매주 SNS 전략 수립 및 실행\n- 키워드 마스터: 키워드 분석 및 콘텐츠 기획\n\n각 크루잉의 기간, 참여 인원, 보상 정보를 확인할 수 있습니다." },
          { title: "크루잉 참여 신청", body: "원하는 크루잉을 선택하고 '참여하기' 버튼을 클릭합니다.\n\n참여 시 확인 사항:\n- 크루잉 기간 (시작일~종료일)\n- 일일 미션 내용\n- 인증 방법 (게시글 작성, 스크린샷 등)\n- 완주 보상 (포인트, 뱃지, 체험권 등)\n\n참여 후에는 마이페이지에서 현재 진행 중인 크루잉과 달성률을 확인할 수 있습니다." },
