...
const FEATURE_ICONS = {
  // 글쓰기 계열
  blog_write: { color: "#3b82f6", label: "글쓰기", svg: (c) => <svg width="48" height="48" viewBox="0 0 24 24" fill="none"><path d="M17 3a2.83 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg> },
  ...
  // 기본
  default: { color: "#3b82f6", label: "AI 작업", svg: (c) => <svg width="48" height="48" viewBox="0 0 24 24" fill="none"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" stroke={c} strokeWidth="1.8" strokeLinecap="round"/></svg> },
};
