...
마크다운 **볼드** 사용하지 마. 순수 텍스트로.` }
  ...
  const renderBriefingContent = (content, isCard = false) => {
    ...
    const accentBg = isDark ? "rgba(0,0,0,0.06)" : "rgba(0,0,0,0.06)";
    ...
    const tagBg = isCard ? (isDark ? "rgba(0,0,0,0.06)" : "rgba(255,255,255,0.18)") : accentBg;
                ...
                return (
                  <div key={h.date}
                    ...
                    style={{
                      ...
                      boxShadow: isExpanded ? `0 2px 12px rgba(0,0,0,0.06)` : "0 1px 4px rgba(0,0,0,0.04)",
                    }}>
            ...
            {currentNews.map((item, i) => (
              <a key={i} href={item.link || undefined} target="_blank" rel="noopener noreferrer"
                ...
                style={{
                  ...
                  background: hoveredIdx === i ? (isDark ? "rgba(0,0,0,0.06)" : "rgba(0,0,0,0.06)") : "transparent",
