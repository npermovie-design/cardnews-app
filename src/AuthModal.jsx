    ...
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(26,23,48,0.45)", display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(8px)" }}>
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: "rgba(18,16,58,0.98)", border: "1px solid rgba(124,106,255,0.25)", borderRadius: 22, padding: "clamp(24px,5vw,36px) clamp(18px,4vw,30px)", width: "100%", maxWidth: 420, position: "relative", boxShadow: "0 24px 64px rgba(0,0,0,0.3)", margin: "0 16px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <div style={{ fontSize: 11, color: C.muted, marginTop: 2 }}>{ko ? "가입 즉시 100P 지급 · AI 생성 비회원 5회 무료" : "Get 100P on signup · 5 free AI generations for guests"}</div>
        </div>
        ...
        {tab === "login" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button onClick={kakaoLogin} disabled={loading}
              style={{ padding: "12px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.15)", cursor: "pointer", background: "#FEE500", color: "#191919", fontSize: 13, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, minHeight: 44 }}>
              <svg width="18" height="18" viewBox="0 0 24 24"><path fill="#191919" d="M12 3C6.48 3 2 6.36 2 10.44c0 2.62 1.75 4.93 4.38 6.24-.13.47-.85 3.04-.88 3.23 0 0-.02.15.08.21.1.06.21.01.21.01.28-.04 3.24-2.13 3.76-2.49.79.11 1.6.17 2.45.17 5.52 0 10-3.36 10-7.37S17.52 3 12 3z"/></svg>
              {ko ? "카카오로 로그인" : "Login with Kakao"}
            </button>
        ...
        {tab === "register" && regStep === 1 && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button onClick={kakaoLogin} disabled={loading}
              style={{ padding: "12px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.15)", cursor: "pointer", background: "#FEE500", color: "#191919", fontSize: 13, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, minHeight: 44 }}>
              <svg width="18" height="18" viewBox="0 0 24 24"><path fill="#191919" d="M12 3C6.48 3 2 6.36 2 10.44c0 2.62 1.75 4.93 4.38 6.24-.13.47-.85 3.04-.88 3.23 0 0-.02.15.08.21.1.06.21.01.21.01.28-.04 3.24-2.13 3.76-2.49.79.11 1.6.17 2.45.17 5.52 0 10-3.36 10-7.37S17.52 3 12 3z"/></svg>
              {ko ? "카카오로 시작하기" : "Sign up with Kakao"}
            </button>
            ...
            <div style={{ background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.15)", borderRadius: 10, padding: "10px 14px" }}>
              ...
              <div style={{ fontSize: 11, color: C.muted, lineHeight: 1.8 }}>
                {ko ? <>
                  ...
                  · <b style={{ color: C.text }}>100P</b> on signup (10 AI uses)<br/>
                  · <b style={{ color: C.text }}>2P</b> per post<br/>
                  · <b style={{ color: C.text }}>3P</b> daily check-in<br/>
