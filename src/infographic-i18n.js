...
const DICT = {
  ...
  s03_p1_desc:      { ko: "무슨 콘텐츠를 만들어야 할지\n감이 안 잡힌다", en: "No idea what content\nto create", ja: "何を作ればいいか\nわからない", zh: "不知道该做\n什么内容", es: "Sin idea de que\ncontenido crear" },
  s03_p2_title:     { ko: "시간이 없다", en: "No time", ja: "時間がない", zh: "没时间", es: "Sin tiempo" },
  s03_p2_desc:      { ko: "하나 만드는 데\n너무 오래 걸린다", en: "Takes too long\nto make one", ja: "一つ作るのに\n時間がかかりすぎる", zh: "做一个\n太费时间", es: "Toma demasiado\ntiempo hacer uno" },
  s03_p3_title:     { ko: "성과가 안 나온다", en: "No results", ja: "成果が出ない", zh: "没效果", es: "Sin resultados" },
  s03_p3_desc:      { ko: "올려도 반응이 없고\n기대만큼 안 된다", en: "No engagement,\nbelow expectations", ja: "投稿しても反応がなく\n期待通りにならない", zh: "发了也没反应\n达不到预期", es: "Sin interaccion,\npor debajo de expectativas" },
  ...
  s08_r1:           { ko: "프리미어 프로\n자동 자막", en: "Premiere Pro\nAuto Subtitles", ja: "Premiere Pro\n自動字幕", zh: "Premiere Pro\n自动字幕", es: "Premiere Pro\nSubtitulos Auto" },
  s08_r1d:          { ko: "영상 자막 자동화", en: "Video subtitle automation", ja: "映像字幕自動化", zh: "视频字幕自动化", es: "Automatizacion de subtitulos" },
  s08_r2:           { ko: "디자인\n템플릿", en: "Design\nTemplates", ja: "デザイン\nテンプレート", zh: "设计\n模板", es: "Plantillas\nde Diseno" },
  ...
  s09_t1d:          { ko: "처음 시작하는데\n뭐부터 해야 할지 모르는 분", en: "Just starting out,\nnot sure where to begin", ja: "始めたいけど\n何からすればいいかわからない方", zh: "刚开始\n不知从何做起的人", es: "Recien empezando,\nsin saber por donde comenzar" },
  s09_t2:           { ko: "1인 사업자", en: "Solo Business", ja: "個人事業者", zh: "个体创业者", es: "Negocio Individual" },
  s09_t2d:          { ko: "SNS 마케팅에\n시간을 쏟기 어려운 분", en: "Too busy for\nSNS marketing", ja: "SNSマーケティングに\n時間を割けない方", zh: "没时间做\n社交媒体营销的人", es: "Sin tiempo para\nmarketing en redes" },
  s09_t3:           { ko: "마케터 · 운영자", en: "Marketers", ja: "マーケター · 運営者", zh: "营销人 · 运营者", es: "Marketers" },
  s09_t3d:          { ko: "이미 운영 중이지만\n효율을 높이고 싶은 분", en: "Already running but\nwant more efficiency", ja: "すでに運営中だが\n効率を高めたい方", zh: "已经在运营但\n想提升效率的人", es: "Ya operando pero\nbuscando mas eficiencia" },
  s09_t4:           { ko: "크리에이터", en: "Creators", ja: "クリエイター", zh: "创作者", es: "Creadores" },
  s09_t4d:          { ko: "더 많은 콘텐츠를\n꾸준히 만들고 싶은 분", en: "Want to create\nmore content consistently", ja: "もっと多くのコンテンツを\n継続的に作りたい方", zh: "想要持续创作\n更多内容的人", es: "Quieren crear\nmas contenido consistentemente" },
