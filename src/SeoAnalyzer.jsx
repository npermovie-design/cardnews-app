          ...
          <div style={{ padding:"24px", borderRadius:16, border:`1px solid ${bdr}`, background:cardBg }}>
            ...
            <div style={{ display:"flex", gap:0, borderBottom:`1px solid ${bdr}`, marginBottom:16 }}>
              {["전체","네이버","구글","다음","빙"].map(eng => {
                ...
                const engColor = eng==="네이버"?"#22c55e":eng==="구글"?"#4285f4":eng==="다음"?"#f59e0b":eng==="빙"?"#0078d4":"#7c6aff";
                return (
                  ...
                  {isExpanded && (
                    <div style={{ padding:"0 22px 22px", borderTop:`1px solid ${bdr}` }}>
                      <div style={{ padding:"12px 14px", margin:"14px 0", borderRadius:10, background:D?"rgba(99,102,241,0.06)":"rgba(99,102,241,0.03)", border:"1px solid rgba(99,102,241,0.1)" }}>
                        <div style={{ fontSize:11, fontWeight:700, color:"#7c6aff", marginBottom:4 }}>📖 평가 기준</div>
            ...
            <div style={{ padding:"24px", borderRadius:16, background:"linear-gradient(135deg, rgba(99,102,241,0.08), rgba(236,72,153,0.06))",
              ...
              <div style={{ display:"flex", gap:8, flexWrap:"wrap" }}>
                <button onClick={() => navigate?.("ai")}
                  style={{ padding:"10px 20px", borderRadius:10, border:"none", background:"linear-gradient(135deg,#7c6aff,#8b5cf6)", color:"#fff", fontSize:13, fontWeight:700, cursor:"pointer" }}>
                  ✍️ AI 블로그 글쓰기
                </button>
                <button onClick={() => navigate?.("ai")}
          ...
          <div style={{ position:"fixed", inset:0, zIndex:9999, background:"rgba(0,0,0,0.6)", display:"flex", alignItems:"center", justifyContent:"center" }}
            ...
            <div onClick={e => e.stopPropagation()}
              ...
              <div style={{ fontSize:13, color:muted, lineHeight:1.8, marginBottom:20 }}>
                비회원은 하루 <b style={{color:"#7c6aff"}}>{AZ_FREE_GUEST}회</b> 무료 분석 가능합니다.<br/>
              ...
              <div style={{ display:"flex", gap:10 }}>
                ...
                <button onClick={() => { setShowLoginPrompt(false); navigate?.("login"); }}
                  style={{ flex:1, padding:"12px", borderRadius:10, border:"none", background:"linear-gradient(135deg,#7c6aff,#8b5cf6)", color:"#fff", fontSize:14, fontWeight:800, cursor:"pointer" }}>
                  로그인하기
                </button>
              </div>
            </div>
