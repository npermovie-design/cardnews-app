          ...
          {menu === "home" && (
            <div style={{ flex:1, overflowY:"auto", padding:"32px 20px 60px" }}>
              <div style={{ maxWidth: 800, margin: "0 auto" }}>
                ...
                {/* 가이드라인 */}
                <div style={{ marginBottom:28, padding:"22px 24px", borderRadius:16, background:isDark?"rgba(0,0,0,0.06)":"rgba(0,0,0,0.06)", border:`1px solid ${isDark?"rgba(0,0,0,0.06)":"rgba(0,0,0,0.06)"}` }}>
                  ...
                  <div style={{ borderTop:`1px solid ${isDark?"rgba(0,0,0,0.06)":"rgba(0,0,0,0.06)"}`, paddingTop:14 }}>
    ...
    <div>
      ...
      {result ? (
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          {/* 종합 분석 */}
          <div style={{ padding:"24px", borderRadius:16, background:D?"rgba(0,0,0,0.06)":"rgba(0,0,0,0.06)", border:"1px solid rgba(0,0,0,0.06)" }}>
        ...
        <div style={{ textAlign:"center", padding:"60px 20px", borderRadius:16, border:`1px solid ${bdr}`, background:cardBg }}>
          <div style={{ width:48, height:48, borderRadius:14, background:isDark?"rgba(0,0,0,0.06)":"rgba(0,0,0,0.06)", margin:"0 auto 14px", display:"flex", alignItems:"center", justifyContent:"center" }}><div style={{width:10,height:10,borderRadius:"50%",background:"#94a3b8"}}/></div>
...
function Sidebar({ menu, setMenu, isDark, text, muted, sideBg, sideBdr }) {
  ...
  const divider = { height:2, background: isDark ? "rgba(0,0,0,0.06)" : "rgba(0,0,0,0.06)", margin:"14px 4px", borderRadius:1 };
  return (
      ...
      <div style={{ maxWidth:900, margin:"0 auto" }}>
        ...
        {loading ? (
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:0 }}>
            ...
            {/* 상세 패널 */}
            {detail && (
              <div style={{ margin:"16px 0", padding:"20px", borderRadius:14, border:`1px solid ${bdr}`, background:D?"rgba(0,0,0,0.06)":"rgba(0,0,0,0.06)" }}>
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
