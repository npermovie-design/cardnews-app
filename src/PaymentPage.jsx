  ...
  return (
    <div style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "0 24px" }}>
      <div style={{ textAlign: "center", maxWidth: 400 }}>
        {status === "processing" && (
          <>
            <div style={{ width:48, height:48, borderRadius:"50%", border:"4px solid rgba(0,0,0,0.06)", borderTopColor:"#3b82f6", margin:"0 auto 16px", animation:"spin 1s linear infinite" }} />
        ...
        {status === "success" && (
          <>
            <div style={{ width:64, height:64, borderRadius:"50%", background:"#3b82f6", margin:"0 auto 16px", display:"flex", alignItems:"center", justifyContent:"center" }}>
            ...
            {points > 0 && <div style={{ fontSize: 28, fontWeight: 900, color: "#3b82f6", marginBottom: 12 }}>+{pointsToUses(points).toLocaleString()}회</div>}
  ...
  return (
    <div style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "0 24px" }}>
      <div style={{ textAlign: "center", maxWidth: 400 }}>
        ...
        <button onClick={() => navigate("pricing")} style={{ padding: "12px 28px", borderRadius: 12, border: "none", background: "#3b82f6", color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer" }}>
          {t("pay_retry")}
        </button>
      </div>
    </div>
