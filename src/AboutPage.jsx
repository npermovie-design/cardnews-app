...
export function HowToPage({ navigate, C }) {
  ...
  const HOW_TO = [
    ...
    },
    {
      ...
      title: p("howtoS6"),
      desc: p("howtoS6d"),
      tips: ["매일 로그인: +2P", "게시글 작성: +1P (하루 10회)", "AI 글쓰기 1회: -20P"],
    },
  ];

  const POINT_INFO = [
    { label: "비회원", val: "5회 무료", color: "#888", bg: "rgba(0,0,0,0.04)" },
    { label: "회원가입", val: "50P 즉시 지급", color: "#10b981", bg: "rgba(16,185,129,0.06)" },
    { label: "매일 로그인", val: "+2P", color: "#10b981", bg: "rgba(16,185,129,0.06)" },
    { label: "게시글 작성", val: "+1P (하루 10회)", color: "#10b981", bg: "rgba(16,185,129,0.06)" },
    { label: "댓글 작성", val: "없음", color: "#888", bg: "rgba(0,0,0,0.04)" },
    { label: "AI 글쓰기", val: "-20P", color: "#ef4444", bg: "rgba(239,68,68,0.05)" },
  ];

  const FAQ = [
    { q: "비회원도 사용할 수 있나요?", a: "네! 로그인 없이 AI 기능을 5회 무료로 체험할 수 있어요. 회원가입 시 50P를 즉시 드려요." },
    { q: "포인트는 어떻게 쌓이나요?", a: "가입 즉시 50P, 매일 로그인 +2P, 게시글 작성 +1P (하루 10회)이 적립돼요. 충전도 가능해요." },
    { q: "생성된 콘텐츠를 상업적으로 사용해도 되나요?", a: "네, 생성된 콘텐츠는 자유롭게 사용하실 수 있어요. 단 법적 책임은 사용자에게 있습니다." },
    { q: "포인트 유효기간이 있나요?", a: "충전 포인트는 유효기간이 없어요. 마음껏 사용하세요." },
    { q: "생성 결과가 마음에 안 들면 어떻게 하나요?", a: "재생성 버튼을 누르면 다시 생성할 수 있어요. 단, 재생성 시에도 동일한 포인트가 차감됩니다." },
...
const FAQ_DATA = [
  ...
  },
  {
    cat: "포인트 & 요금",
    items: [
      { q: "무료로 사용할 수 있나요?", a: "네! 비회원도 AI 생성기 5회 무료 체험이 가능하고, 회원 가입 시 50P가 즉시 지급됩니다. AI 분석기는 비회원 하루 5회, 회원 하루 5회 무료로 이용 가능합니다." },
      { q: "포인트는 어떻게 충전하나요?", a: "가격정책 페이지에서 원하는 포인트 패키지를 선택하여 결제하시면 즉시 충전됩니다. 또한 매일 로그인 시 +2P, 게시글 작성 시 +1P (하루 10회)가 자동 적립됩니다." },
      { q: "AI 생성 1회에 포인트가 얼마나 소모되나요?", a: "기능별로 다릅니다. AI 글쓰기 = 20P, AI 이미지 생성 = 200P, 상세페이지 = 45P 등이며, 자세한 단가는 가격정책 페이지에서 확인할 수 있습니다." },
