...
export function HowToPage({ navigate, C }) {
  ...
  const FAQ = [
    ...
    { q: "포인트는 어떻게 쌓이나요?", a: "가입 즉시 100P, 매일 출석체크로 +3P, 게시글 작성 시 +1P가 적립돼요. 충전도 가능해요." },
...
const FAQ_DATA = [
  ...
  },
  {
    cat: "포인트 & 요금",
    items: [
      { q: "무료로 사용할 수 있나요?", a: "네! 비회원도 AI 생성기 5회 무료 체험이 가능하고, 회원 가입 시 200P가 즉시 지급됩니다. AI 분석기는 비회원 하루 5회, 회원 하루 5회 무료로 이용 가능합니다." },
