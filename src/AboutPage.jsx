  ...
  const HOW_TO = [
    {
      ...
      title: p("howtoS1"),
      desc: p("howtoS1d"),
      tips: ["구글·카카오 소셜 로그인 지원", "비회원 5회 무료 체험", "가입 즉시 50P 지급"],
    },
    {
      step: "02", icon: "", color: "#8b5cf6",
      title: p("howtoS2"),
      desc: p("howtoS2d"),
      tips: ["SNS 글쓰기: 블로그·인스타·유튜브·스레드 등", "콘텐츠 제작: 상세페이지·쇼츠 영상", "이미지 생성: 제품컷·로고·목업·모델"],
    },
    {
    ...
    },
    {
      ...
      title: p("howtoS6"),
      desc: p("howtoS6d"),
      tips: ["매일 로그인: +2회", "게시글 작성: +1회 (하루 10회)", "AI 글쓰기 1회: -20회"],
    },
  ];

  const POINT_INFO = [
    { label: "비회원", val: "5회 무료", color: "#888", bg: "rgba(0,0,0,0.04)" },
    { label: "회원가입", val: "50회 즉시 제공", color: "#10b981", bg: "rgba(16,185,129,0.06)" },
    { label: "매일 로그인", val: "+2회", color: "#10b981", bg: "rgba(16,185,129,0.06)" },
    { label: "게시글 작성", val: "+1회 (하루 10회)", color: "#10b981", bg: "rgba(16,185,129,0.06)" },
    { label: "댓글 작성", val: "없음", color: "#888", bg: "rgba(0,0,0,0.04)" },
    { label: "AI 글쓰기", val: "-20회", color: "#ef4444", bg: "rgba(239,68,68,0.05)" },
  ];

  const FAQ = [
    { q: "비회원도 사용할 수 있나요?", a: "네! 로그인 없이 AI 기능을 5회 무료로 체험할 수 있어요. 회원가입 시 이용권 50회를 즉시 드려요." },
    { q: "이용권은 어떻게 쌓이나요?", a: "가입 즉시 50회, 매일 로그인 +2회, 게시글 작성 +1회 (하루 10회)이 적립돼요. 구독도 가능해요." },
    { q: "생성된 콘텐츠를 상업적으로 사용해도 되나요?", a: "네, 생성된 콘텐츠는 자유롭게 사용하실 수 있어요. 단 법적 책임은 사용자에게 있습니다." },
    { q: "이용권 유효기간이 있나요?", a: "구독으로 제공된 이용권은 구독 기간 내에만 유효합니다." },
    { q: "생성 결과가 마음에 안 들면 어떻게 하나요?", a: "재생성 버튼을 누르면 다시 생성할 수 있어요. 단, 재생성 시에도 동일한 이용권이 차감됩니다." },
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ background: C.card, border: "1px solid " + C.border, borderRadius: 20, padding: "36px 32px", marginBottom: 28, boxShadow: C.shadow }}>
          ...
          <div style={{ marginTop: 16, padding: "14px 18px", borderRadius: 12, background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.15)" }}>
            <p style={{ fontSize: 13, color: C.muted, margin: 0, lineHeight: 1.8 }}>
              구독 플랜: <b style={{ color: C.text }}>Standard 3,500회 — 19,900원</b> · <b style={{ color: C.text }}>Pro 9,500회 — 49,900원</b>
            </p>
          </div>
        </div>
...
const FAQ_DATA = [
  {
    cat: "서비스 소개",
    items: [
      { q: "SNS메이킷은 어떤 서비스인가요?", a: "SNS메이킷은 AI를 활용하여 블로그 글, 상세페이지, 제품 이미지, 쇼츠 영상 등 SNS 콘텐츠를 자동으로 생성해주는 올인원 플랫폼입니다. 실시간 검색어 분석과 인플루언서·브랜드 TOP10 랭킹 기능도 제공합니다." },
      { q: "어떤 AI 도구를 사용할 수 있나요?", a: "네이버 블로그, 티스토리, 인스타그램 캡션, 유튜브 대본, 스레드 등 글쓰기 도구와 상세페이지, 제품컷, 로고, 목업, AI 모델, 얼굴/의상 교체, 여백 확장, 쇼츠 자동 편집 등 총 20가지 이상의 AI 도구를 제공합니다." },
  ...
  },
  {
    cat: "이용권 & 요금",
    items: [
      { q: "무료로 사용할 수 있나요?", a: "네! 비회원도 AI 생성기 5회 무료 체험이 가능하고, 회원 가입 시 이용권 50회가 즉시 제공됩니다. AI 분석기는 비회원 하루 5회, 회원 하루 5회 무료로 이용 가능합니다." },
      { q: "이용권은 어떻게 구독하나요?", a: "가격정책 페이지에서 원하는 구독 플랜을 선택하여 결제하시면 즉시 이용권이 제공됩니다. 또한 매일 로그인 시 +2회, 게시글 작성 시 +1회 (하루 10회)가 자동 적립됩니다." },
      { q: "AI 생성 1회에 이용권이 얼마나 소모되나요?", a: "기능별로 다릅니다. AI 글쓰기 = 20회, AI 이미지 생성 = 200회, 상세페이지 = 45회 등이며, 자세한 단가는 가격정책 페이지에서 확인할 수 있습니다." },
      { q: "이용권 환불이 가능한가요?", a: "미사용 이용권에 대해서는 결제일로부터 7일 이내 환불 요청이 가능합니다. 문의하기 페이지에서 환불 요청을 보내주세요." },
    ],
  },
  {
    cat: "AI 생성기",
    items: [
      ...
      { q: "생성 결과가 마음에 들지 않으면 다시 생성할 수 있나요?", a: "네, 같은 주제로 다시 생성하면 매번 새로운 결과물이 나옵니다. 다만 재생성 시에도 이용권이 차감됩니다." },
      { q: "상세페이지에서 텍스트를 직접 수정할 수 있나요?", a: "네, AI가 생성한 후 편집 화면에서 제목, 본문, 색상, 배경 등을 자유롭게 수정할 수 있습니다. 수정 후 PNG 또는 ZIP으로 다운로드하세요." },
  ...
  },
  {
    cat: "계정 & 기타",
    items: [
      { q: "회원가입은 어떻게 하나요?", a: "이메일과 비밀번호로 간단하게 가입할 수 있습니다. 가입 즉시 50P가 지급되며 바로 AI 도구를 사용하실 수 있습니다." },
