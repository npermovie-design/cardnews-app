...
const TEMPLATES = [
  ...
  { name: "핑크 그라데이션", category: "카드뉴스", bgColor: "#fdf2f8", textColor: "#831843", accentColor: "#ec4899", fontFamily: "GowunDodum", layout: "center" },
  { name: "민트 프레시", category: "카드뉴스", bgColor: "#f0fdfa", textColor: "#134e4a", accentColor: "#14b8a6", fontFamily: "Nanum Gothic", layout: "corner-accent" },
  { name: "감성 일기", category: "카드뉴스", bgColor: "#fffbeb", textColor: "#78350f", accentColor: "#d97706", fontFamily: "Nanum Pen Script", layout: "quote" },
  { name: "딥 퍼플", category: "카드뉴스", bgColor: "#2e1065", textColor: "#e9d5ff", accentColor: "#a78bfa", fontFamily: "Pretendard", layout: "top-bold" },
  { name: "체크리스트", category: "카드뉴스", bgColor: "#f8fafc", textColor: "#1e293b", accentColor: "#3b82f6", fontFamily: "Pretendard", layout: "left-bar" },
  { name: "오렌지 팝", category: "카드뉴스", bgColor: "#431407", textColor: "#ffffff", accentColor: "#fb923c", fontFamily: "BMDOHYEON", layout: "stripe" },
  { name: "로즈 엘레강스", category: "카드뉴스", bgColor: "#1c1917", textColor: "#fecdd3", accentColor: "#fb7185", fontFamily: "Nanum Myeongjo", layout: "magazine" },
  { name: "클린 화이트", category: "카드뉴스", bgColor: "#ffffff", textColor: "#374151", accentColor: "#6366f1", fontFamily: "Pretendard", layout: "minimal" },
  // 프레젠테이션
  ...
  { name: "테크 다크", category: "프레젠테이션", bgColor: "#0f172a", textColor: "#e2e8f0", accentColor: "#38bdf8", fontFamily: "Pretendard", layout: "left-bar" },
  { name: "투자 피치", category: "프레젠테이션", bgColor: "#18181b", textColor: "#ffffff", accentColor: "#a78bfa", fontFamily: "Pretendard", layout: "stripe" },
  { name: "교육 자료", category: "프레젠테이션", bgColor: "#fefce8", textColor: "#1c1917", accentColor: "#eab308", fontFamily: "Noto Sans KR", layout: "center" },
  { name: "컨퍼런스", category: "프레젠테이션", bgColor: "#0c0a09", textColor: "#ffffff", accentColor: "#f97316", fontFamily: "Montserrat", layout: "magazine" },
  // 상세페이지
  ...
  { name: "뷰티 핑크", category: "상세페이지", bgColor: "#fff1f2", textColor: "#4c0519", accentColor: "#f43f5e", fontFamily: "Nanum Myeongjo", layout: "center" },
  { name: "헬스 그린", category: "상세페이지", bgColor: "#f0fdf4", textColor: "#14532d", accentColor: "#22c55e", fontFamily: "Pretendard", layout: "top-bold" },
  { name: "테크 제품", category: "상세페이지", bgColor: "#09090b", textColor: "#fafafa", accentColor: "#3b82f6", fontFamily: "Pretendard", layout: "split-left" },
  // 소셜미디어
  ...
  { name: "인스타 스토리", category: "소셜미디어", bgColor: "#833ab4", textColor: "#ffffff", accentColor: "#fd1d1d", fontFamily: "Pretendard", layout: "center" },
  { name: "트위터 블루", category: "소셜미디어", bgColor: "#15202b", textColor: "#ffffff", accentColor: "#1d9bf0", fontFamily: "Pretendard", layout: "left-bar" },
  { name: "링크드인 프로", category: "소셜미디어", bgColor: "#0a66c2", textColor: "#ffffff", accentColor: "#b4d4f7", fontFamily: "Pretendard", layout: "split-left" },
  { name: "페이스북 라이트", category: "소셜미디어", bgColor: "#f0f2f5", textColor: "#1c1e21", accentColor: "#1877f2", fontFamily: "Noto Sans KR", layout: "minimal" },
  { name: "핀터레스트 레드", category: "소셜미디어", bgColor: "#fffdf7", textColor: "#333333", accentColor: "#e60023", fontFamily: "Nanum Gothic", layout: "magazine" },
  // 트렌디
  { name: "글래스모피즘", category: "트렌디", bgColor: "#0f0f23", textColor: "#ffffff", accentColor: "#818cf8", fontFamily: "Pretendard", layout: "center" },
  { name: "뉴모피즘", category: "트렌디", bgColor: "#e0e5ec", textColor: "#44476a", accentColor: "#6c63ff", fontFamily: "Pretendard", layout: "minimal" },
  { name: "Y2K 레트로", category: "트렌디", bgColor: "#ff69b4", textColor: "#ffffff", accentColor: "#00ffff", fontFamily: "Do Hyeon", layout: "corner-accent" },
  { name: "사이버펑크", category: "트렌디", bgColor: "#0d0221", textColor: "#ff00ff", accentColor: "#00ff41", fontFamily: "NeoDunggeunmo", layout: "stripe" },
  { name: "아날로그 필름", category: "트렌디", bgColor: "#f5e6d3", textColor: "#2c1810", accentColor: "#8b6914", fontFamily: "GowunBatang", layout: "quote" },
  { name: "그라디언트 메시", category: "트렌디", bgColor: "#667eea", textColor: "#ffffff", accentColor: "#f093fb", fontFamily: "Pretendard", layout: "top-bold" },
  { name: "미니멀 라인", category: "트렌디", bgColor: "#fafaf9", textColor: "#1c1917", accentColor: "#000000", fontFamily: "Inter", layout: "minimal" },
  { name: "네온 다크", category: "트렌디", bgColor: "#0a0a0a", textColor: "#39ff14", accentColor: "#ff073a", fontFamily: "Black Han Sans", layout: "left-bar" },
];
