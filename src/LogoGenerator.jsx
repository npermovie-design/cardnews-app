...
const LOGO_STYLES = [
  ...
  { id:"symbol_kr",  label:"한글 심볼 로고",     desc:"한글 타이포 중심",    color:"#3b82f6", bg:"rgba(0,0,0,0.06)" },
  { id:"letter_en",  label:"영문 레터링·캐릭터", desc:"영문 + 캐릭터 혼합",  color:"#8b5cf6", bg:"rgba(139,92,246,0.15)" },
  { id:"calli_en",   label:"영문 캘리그라피",    desc:"손글씨 스타일",       color:"#60a5fa", bg:"rgba(167,139,250,0.15)" },
