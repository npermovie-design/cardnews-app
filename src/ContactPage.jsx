  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "48px 20px 80px" }}>
      ...
      <button onClick={() => { if (window.ChannelIO) window.ChannelIO("showMessenger"); }}
        ...
        <span style={{ fontSize: 13, fontWeight: 700, color: "#3b82f6", flexShrink: 0 }}>{p("contactChatBtn")}</span>
      </button>
        ...
        <div style={{ background: C.card, border: "1px solid " + C.border, borderRadius: 20, padding: "32px 28px", boxShadow: C.shadow }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <button onClick={submit} disabled={submitting}
              style={{ padding: "14px", borderRadius: 12, border: "none", cursor: submitting?"not-allowed":"pointer", background: "#3b82f6", color: "#fff", fontSize: 14, fontWeight: 700, boxShadow: "0 4px 16px rgba(0,0,0,0.06)", opacity: submitting?0.7:1, minHeight: 44 }}>
