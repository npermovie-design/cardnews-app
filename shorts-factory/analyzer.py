...
구간 시작점 (가장 중요!!!):
- start_seconds는 반드시 자막 타임스탬프의 시작점을 사용
- 화자가 새로운 문장/주제를 시작하는 지점이어야 함
- "~입니다." "~해요." "~거든요." 같은 문장이 끝난 직후의 다음 자막 시작점을 선택
- 말이 이어지는 중간에서 자르면 절대 안 됨 (예: "그래서" "그리고" 뒤에서 시작 금지)
- 첫 자막이 완전한 문장의 시작이어야 시청자가 맥락을 이해함

구간 끝점 (가장 중요!!!):
- end_seconds는 반드시 완전한 문장이 끝나는 자막의 끝점을 사용
- 마지막 문장은 반드시 "~요" "~다" "~습니다" "~죠" "~세요" "~거든요" "~잖아요" "~네요" "~까요" 로 끝나야 함
- "~하고" "~해서" "~인데" "~지만" "~그래서" "~근데" 같은 접속/연결 표현으로 끝나면 절대 안 됨
- 말이 어중간하게 끊기면 안 됨. 화자가 "내렸었거든요" "합니다" 처럼 확실하게 마무리하는 지점
